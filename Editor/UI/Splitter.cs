...
namespace UTJ.FrameDebugSave.UI
{
    ...
    public class Splitter : VisualElement
    {
        ...
        private int rightMinWidth;

        private int upMinHeight;
        private int downMinHeight;
        ...
        public new class UxmlTraits : VisualElement.UxmlTraits
        {
            ...
            UxmlStringAttributeDescription splitTypeAttr =
                new UxmlStringAttributeDescription { name = "splitType" };
            UxmlIntAttributeDescription leftMinAttr =
                new UxmlIntAttributeDescription { name = "leftMin" };
            UxmlIntAttributeDescription rightMinAttr =
                new UxmlIntAttributeDescription { name = "rightMin" };
            UxmlIntAttributeDescription topMinAttr =
                new UxmlIntAttributeDescription { name = "topMin" };
            UxmlIntAttributeDescription buttomMinAttr =
                new UxmlIntAttributeDescription { name = "bottomMin" };
            ...
            public override void Init(VisualElement ve, IUxmlAttributes bag, CreationContext cc)
            {
                ...
                Splitter splitter = ve as Splitter;
                if (splitter == null) { return; }
                string type = splitTypeAttr.GetValueFromBag(bag, cc);
                if(type == "vertical") {
                    splitter.splitType = SplitType.Vertical;
                }
                else
                {
                    splitter.splitType = SplitType.Horizontal;
                }
                splitter.upMinHeight = topMinAttr.GetValueFromBag(bag, cc);
                splitter.downMinHeight = buttomMinAttr.GetValueFromBag(bag, cc);
                splitter.leftMinWidth = leftMinAttr.GetValueFromBag(bag, cc);
                splitter.rightMinWidth = rightMinAttr.GetValueFromBag(bag, cc);
        ...
        private void Init()
        {
            if (this.splitType == SplitType.Horizontal)
            {
                this.AddToClassList("resize-hori");
            }
            else
            {
                this.AddToClassList("resize-vert");
            }
        ...
        {
            Debug.Log("OnMouseDown" + e.localMousePosition);
        }
        private void OnMouseMove(MouseMoveEvent e)
        {
            Debug.Log("OnMouseMove" + e.localMousePosition);

        }
        private void OnMouseUp(MouseUpEvent e)
        {
            Debug.Log("OnMouseUp" + e.localMousePosition);
